...
export const getList = () => {
  return dispatch => {
    axios.get("api/json/hotword").then(res => {
...
export const getAppDownloadAction=()=>{
  return {
    type:actionTypes.HANDLE_CHANGE_APP_DOWNLOAD,
    getApp:true
  }
}
export const getAppCloseAction=()=>{
  return {
    type:actionTypes.HANDLE_CHANGE_APP_CLOSE,
    getApp:false
  }
}
